...
<body>
	...
	<a href="menu2.php"><i style="color: white; font-size: 2.5em; margin-left: 5%; padding-top: 4.5%;" class="fa fa-arrow-left"></i></a>
	...
	<main>
		...
		<table class="table2"  border="1">
			...
			<tr>
				...
				<th class="th2" style="color: black;text-align: center;font-size: 0.9em; ">Unidades Curriculares</th>
				<th class="th2" style="color: black;text-align: center;font-size: 0.9em;">Carga Horária</th>
