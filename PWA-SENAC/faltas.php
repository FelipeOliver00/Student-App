...
<body>
	...
	<main>
		...
		<h2 style="font-size: 1.5em; color: white; text-align: center; padding-top: 10%; font-family: 'Orbitron', sans-serif;">Faltas</h2>
		...
		<table border="1">
			...
			<tr>
				...
				<th style="color: black;text-align: center;font-size: 0.9em;">Presenças</th>
				<th style="color: black; text-align: center;font-size: 0.9em;">Faltas</th>
			...
			<tr>
				...
				<td><?php echo $linha['tp'].":00"; ?></td>
				<td><?php echo $linha['tf'].":00"; ?></td>
